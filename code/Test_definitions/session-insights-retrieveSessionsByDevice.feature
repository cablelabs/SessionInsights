Feature: CAMARA Session Insights API, vwip - Operation retrieveSessionsByDevice
  ...
  @session_insights_retrieveSessionsByDevice_01_phone_number_2legged_token
  ...
  Scenario: Retrieve sessions for device with IPv4 address using 2-legged token
    ...
    And the request body property "$.device.ipv4Address.publicAddress" is set to that device public IPv4 address
    And the request body property "$.device.ipv4Address.publicPort" is set to that device public port
    When the request "retrieveSessionsByDevice" is sent
    Then the response status code is 200
    And the response header "Content-Type" is "application/json"
    And the response header "x-correlator" has same value as the request header "x-correlator"
  ...
  @session_insights_retrieveSessionsByDevice_03_ipv6_address_2legged_token
  ...
  @session_insights_retrieveSessionsByDevice_04_network_access_identifier_2legged_token
  ...
  @session_insights_retrieveSessionsByDevice_05_3legged_token_without_device
  ...
  @session_insights_retrieveSessionsByDevice_06_empty_array_no_sessions
  ...
  @session_insights_retrieveSessionsByDevice_07_multiple_device_identifiers
  Scenario: Retrieve sessions with device having multiple identifiers
    ...
    And the request body property "$.device.ipv4Address.publicAddress" is set to a valid public IPv4 address
    And the request body property "$.device.ipv4Address.publicPort" is set to a valid public port
    When the request "retrieveSessionsByDevice" is sent
    Then the response status code is 200
  ...
  @session_insights_retrieveSessionsByDevice_400.1_invalid_phone_number_format
  ...
  @session_insights_retrieveSessionsByDevice_400.2_invalid_ipv4_address_format
  ...
  @session_insights_retrieveSessionsByDevice_400.3_invalid_ipv6_address_format
  ...
  @session_insights_retrieveSessionsByDevice_400.4_device_no_identifiers
  ...
  @session_insights_retrieveSessionsByDevice_400.5_invalid_content_type
  ...
  @session_insights_retrieveSessionsByDevice_400.6_malformed_json
  ...
  @session_insights_retrieveSessionsByDevice_400.7_empty_request_body
  ...
  @session_insights_retrieveSessionsByDevice_401.1_no_authorization_header
  ...
  @session_insights_retrieveSessionsByDevice_401.2_expired_access_token
  ...
  @session_insights_retrieveSessionsByDevice_401.3_invalid_access_token
  ...
  @session_insights_retrieveSessionsByDevice_403.1_missing_access_token_scope
  ...
  @session_insights_retrieveSessionsByDevice_404.1_device_not_found
  ...
  @session_insights_retrieveSessionsByDevice_422.1_2legged_token_missing_device
  ...
  @session_insights_retrieveSessionsByDevice_422.2_3legged_token_with_device
  ...
  @session_insights_retrieveSessionsByDevice_429.1_rate_limit_exceeded
